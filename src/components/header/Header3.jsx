...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "TOGGLE_SIDEBAR_MENU":
      return { ...state, isSidebarOpenMenu: !state.isSidebarOpenMenu };
...
function Header3() {
  ...
  // Smooth scroll to a section ID (with sticky header offset)
  const scrollToId = (id) => {
  ...
  // Navigate or scroll depending on current route
  const goTo = (id) => (e) => {
    e.preventDefault();
  ...
  // Handle initial load with #hash (direct link / refresh)
  useEffect(() => {
    if (typeof window === "undefined") return;
    const hash = window.location.hash?.slice(1);
    if (hash) {
      // wait a tick to ensure sections are in DOM
      ...
      >
        <div className="header-logo">
          <Link legacyBehavior href="/">
            <a onClick={(e) => { e.preventDefault(); router.push("/#home"); }}>
              <img
                alt="image"
                className="img-fluid"
        ...
        <div className={`main-menu ${state.isSidebarOpenMenu ? "show-menu" : ""}`}>
          <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div className="mobile-logo-wrap">
              <Link legacyBehavior href="/">
                <a onClick={(e) => { e.preventDefault(); router.push("/#home"); closeMobile(); }}>
                  <img alt="image" src="assets/logo2.png" width={170} />
                </a>
              </Link>
            </div>
          </div>
          ...
          <ul className="menu-list">
            <li><a href="/#home" onClick={goTo("home")}>Home</a></li>
            <li><a href="/#solutions" onClick={goTo("solutions")}>Our Solutions</a></li>
            <li><a href="/#partners" onClick={goTo("partners")}>Our Clients</a></li>
            <li><a href="/#portfolio-1" onClick={goTo("portfolio-1")}>Our Portfolio</a></li>
            <li><a href="/#about" onClick={goTo("about")}>Our Story</a></li>
          </ul>

          {/* Mobile extra info keeps as-is */}
            ...
            <form className="mobile-menu-form">
              <div className="hotline">
                ...
                <div className="hotline-info">
                  ...
                  <h6><a href="tel:+2304896471">+230 489 6471</a></h6>
                  <h6><a href="tel:+23052592335">+230 5259 2335</a></h6>
                </div>
              </div>
              ...
              <div className="email pt-20 d-flex align-items-center">
                ...
                <div className="email-info">
                  <span>Email Now</span>
                  <h6>
                    <a href="mailto:admin@mantraconnexions.mu">
                      admin@mantra<br/>connexions.mu
                    </a>
                  </h6>
                </div>
              </div>
